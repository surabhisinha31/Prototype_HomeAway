		...
		return(
			...
			<div className="topheader-style">
				...
				<div className="home-login">
					<div>
					<h1 className="login-header"> Sign up for HomeAway </h1>
					<div className="account-para">
					<h3 className= "login-header"> Already have an account ?
					 	<a href="/" className="header-img"> Log in</a>
					 </h3>
					</div>
					</div>
                      ...
                      onChange={(userinput) => {
                          this.userDetails.password=userinput.target.value}}/>
    						      ...
    						      <button type="button" onClick={() =>
												...
												this.props.userSignUp(this.userDetails):''} className="btn btn-primary">Sign Me Up</button>
